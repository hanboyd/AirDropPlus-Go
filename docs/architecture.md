...
- 字体系统仅在品牌标题使用 Charter；UI 标题使用 Microsoft YaHei UI 600，正文和中英文混排使用 Microsoft YaHei UI 400。正文、次要信息和弱提示分别不浅于 `#333333`、`#666666`、`#707070`，边框使用不透明 `#D8D8D8`，避免细衬线和低对比抗锯齿造成视觉雾化。
